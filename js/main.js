...
animateCursor();
document
	.querySelectorAll('a,button,.project-card,.skill-item,.nav-cta,.submit-btn')
	.forEach((el) => {
...
if (heroGrid && heroGlow) {
	window.addEventListener('scroll', () => {
		...
		if (s < window.innerHeight) {
			heroGrid.style.transform = `translate(${s * 0.03}px,${s * 0.15}px)`;
			heroGlow.style.transform = `translate(-50%,-50%) scale(${1 + s * 0.0005})`;
		}
	});
}
...
console.log(
	...
	'font-size:20px;font-weight:bold;color:#00F5A0',
);
console.log(
...
console.log(
	'%chttps://github.com/Sabarinathan07',
	'font-size:12px;color:#00F5A0',
);
console.log(
	'%chttps://www.linkedin.com/in/Sabarinathan07/',
	'font-size:12px;color:#00F5A0',
);
